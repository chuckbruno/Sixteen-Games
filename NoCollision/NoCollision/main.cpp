// NoCollision.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	sf::RenderWindow window(sf::VideoMode(conf.win_width, conf.win_height), "NoCollision", sf::Style::Close, settings);
	...
	display_manager.event_manager.addKeyPressedCallback(sf::Keyboard::A, [&](sfev::CstEv) {drawTraces = !drawTraces; });
